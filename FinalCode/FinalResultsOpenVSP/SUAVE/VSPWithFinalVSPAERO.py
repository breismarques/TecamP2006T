...
def mission_setup(analyses,vehicle):
    ...
    segment.state.numerics.config_tag = 'takeoff'
    segment.state.numerics.engines_number_tot = vehicle.takeoff.propulsors.propulsor.number_of_engines_forward + vehicle.takeoff.propulsors.propulsor.number_of_engines_lift
    ...
    segment_2.state.numerics.engines_number_tot = vehicle.base.propulsors.propulsor.number_of_engines_forward + vehicle.base.propulsors.propulsor.number_of_engines_lift
    segment_2.state.numerics.config_tag = 'base'
    ...
    # segment attributes     
    segment.state.numerics.number_control_points = 8
    segment.state.numerics.engines_number_tot = vehicle.cruise.propulsors.propulsor.number_of_engines_forward + vehicle.cruise.propulsors.propulsor.number_of_engines_lift
    segment.state.numerics.config_tag = 'cruise'
    ...
    segment.state.numerics.number_control_points = 8
    segment.state.numerics.engines_number_tot = vehicle.base.propulsors.propulsor.number_of_engines_forward + vehicle.base.propulsors.propulsor.number_of_engines_lift
    segment.state.numerics.config_tag = 'base'
    ...
    segment.state.numerics.number_control_points = 8
    segment.state.numerics.engines_number_tot = vehicle.landing.propulsors.propulsor.number_of_engines_forward + vehicle.landing.propulsors.propulsor.number_of_engines_lift
    segment.state.numerics.config_tag = 'landing'
...
def plot_mission(configs,results):
    ...
    for segment in results.segments.values():
        ...
        time   = segment.conditions.frames.inertial.time[:,0] / Units['m/s'] 
