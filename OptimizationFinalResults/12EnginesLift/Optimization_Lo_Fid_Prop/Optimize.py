...
def setup():
    ...
    problem.inputs = np.array([
        ...
        [ 'payload_draw'      ,   50.1   , (  5.   ,   100.    ) ,  50.1   , Units.watts],
        [ 'avionics_draw'      ,   50.1   , (  5.   ,   100.    ) ,  50.1   , Units.watts],
    ])
    ...
    problem.constraints = np.array([
        ...
        [ 'battery_energy_min'     , '>', -0.01, 100000.0, Units.Wh  ],
        ...
        [ 'HL_rpm_max'           , '<', 70000, 1.0, Units['rpm']],
        [ 'cruise_rpm_min'       , '>', -0.1, 1.0, Units['rpm']],
        [ 'cruise_rpm_max'       , '<', 100000, 1.0, Units['rpm']],
