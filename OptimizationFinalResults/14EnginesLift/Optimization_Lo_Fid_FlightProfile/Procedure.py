...
def post_process(nexus):
    ...
    #if math.isnan(summary.max_battery_energy_all_segments)==True:
    #    summary.max_battery_energy_all_segments=100000000000000000000000.0
    
    summary.min_battery_energy_all_segments = np.min(energy)
    
    #if math.isnan(summary.min_battery_energy_all_segments)==True:
    #    summary.min_battery_energy_all_segments=-100000000000000000000000.0
    ...
    #if math.isnan(summary.min_rpm_lift_all_segments)==True:
    #    summary.min_rpm_lift_all_segments=-10000000000.0
        
    summary.max_rpm_lift_all_segments = np.max(rpm_lift)
    
    #if math.isnan(summary.max_rpm_lift_all_segments)==True:
    #    summary.max_rpm_lift_all_segments=100000000000.0
    ...
    #if math.isnan(summary.min_rpm_forward_all_segments)==True:
    #    summary.min_rpm_forward_all_segments=-10000000000.0
    
    summary.max_rpm_forward_all_segments = np.max(rpm_forward)
    
    #if math.isnan(summary.max_rpm_forward_all_segments)==True:
    #    summary.max_rpm_forward_all_segments=10000000000.0
    ...
    #if math.isnan(summary.max_lift_coefficient_all_segments)==True:
    #    summary.max_lift_coefficient_all_segments=10000000000.0
    
    summary.min_lift_coefficient_all_segments = np.min(lift_coefficient)
    
    #if math.isnan(summary.min_lift_coefficient_all_segments)==True:
    #    summary.min_lift_coefficient_all_segments=-10000000000.0
    ...
    #if math.isnan(summary.min_aoa_all_segments)==True:
    #    summary.min_aoa_all_segments=-100000000.0
        
    summary.max_aoa_all_segments=np.max(AoA)
    
    #if math.isnan(summary.max_aoa_all_segments)==True:
    #    summary.max_aoa_all_segments=100000000.0
    ...
    #if math.isnan(summary.max_mach_number_all_segments)==True:
    #    summary.max_mach_number_all_segments=10000000.0
