...
def setup():
    ...
    problem.inputs = np.array([
        ...
        [ 'cruise_distance'        ,  150.    , (   50.  ,    500.   ) ,   150.  , Units.nautical_miles],
        [ 'cruise_airspeed'        ,  200.   , (   90.  ,    280.   ) ,   200.  , Units['m/s']],
        [ 'climb1_airspeed'        , 125.0   , (   50.0  ,  230.0      ) ,  125.0   , Units['m/s']],
        [ 'climb2_airspeed'        ,  190.0   , ( 70.0    ,  250.0     ) ,   190.0  , Units['m/s']],
        [ 'descent1_airspeed'      ,  180.0  , ( 100.    ,  250.     ) ,  180.0   , Units['m/s']],
        [ 'descent2_airspeed'      ,   145.0   , ( 50.    ,  180.0     ) ,  145.0   , Units['m/s']],
        [ 'climb1_altitude'        ,   3.  , (  1.   ,  5.     ) ,  3.   , Units.km],
        [ 'climb2_altitude'        ,   8.0   , (   7.  ,  15.     ) , 8.0    , Units.km],
        [ 'descent1_altitude'      ,  3.0    , (  2.   ,  7.     ) ,   3.0  , Units.km],
        [ 'climb1_rate'        ,    6.0  , (   3.  ,  13.     ) ,  6.0   , Units['m/s']],
        [ 'climb2_rate'        ,    3.0  , (  2.   ,   9.    ) ,   3.0  , Units['m/s']],
        [ 'descent1_rate'      ,   4.5   , (  3.   ,   10.    ) ,  4.5   , Units['m/s']],
        [ 'descent2_rate'      ,    3.0  , (  2.   ,   8.    ) ,  3.0   , Units['m/s']],
    ...
    problem.aliases = [
        ...
        #[ 'Throttle_cruise_min'            ,   'summary.min_throttle_all_segments'              ],
        [ 'Throttle_cruise'            ,   'summary.throttle_all_segments'              ],
        #[ 'Throttle_HL_min'            ,   'summary.min_lift_throttle_all_segments'              ],
