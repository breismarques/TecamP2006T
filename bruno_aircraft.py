...
def vehicle_setup():
    ...
    prop_forward.tip_radius          = 0.762 * Units.meter
    ...
    prop_forward.design_power        = 250000. * Units.watts 
    ...
    prop_lift.tip_radius          = 0.2880360 * Units.meter
...
def mission_setup(analyses,vehicle):
    ...
    all_motors_segment.state.unknowns.propeller_power_coefficient_lift = vehicle.base.propulsors.propulsor.propeller_lift.Cp[0]  * ones_row(1)
    all_motors_segment.state.unknowns.propeller_power_coefficient  = vehicle.base.propulsors.propulsor.propeller_forward.Cp[0]  * ones_row(1)
    ...
    segment.climb_rate     = 15.24  * Units['m/s']
